...
import { LahjaListaAuth } from '~/backend/lahjalista-auth/auth/src';
import { LahjalistaAuthAdapter } from '~/backend/lahjalista-auth/db-adapter/src';
import prisma from '~/prisma';

export async function getServerSideProps(context: GetServerSidePropsContext) {
  console.log('Hello!');
  const dbAdapter = new LahjalistaAuthAdapter(prisma);
  const auth = new LahjaListaAuth(dbAdapter);
  console.log(auth);
  return {
    props: {},
  };
